 ...
 <section  id="sectionManager"class="section-container">
         ...
         <div class="content-wrapper">
            <div class="content-heading">
               ...
               <div class="ml-auto">
                  <a href="{{route('addSectionAdd')}}"><button class="btn btn-info btn-lg" type="button">New</button></a>
                   <a href="{{route('reOrder')}}"><button class="btn btn-info btn-lg" type="button">Reorder</button></a>
