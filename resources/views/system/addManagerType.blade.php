...
<section id="sectionManager" class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <form action="{{route('addManagerTypeAdd')}}" method="post">
            @csrf
            <div class="content-heading px-4 d-block d-md-flex">
                <div class="text-dark">{{__('System')}}/{{__('Managers')}}/{{__('New Manager Type')}}</div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 p-0">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" name="name" style="border-right: 1px solid  red;" value="{{old('name')}}" type="text" required>
                                @if ($errors->has('name'))
                                            ...
                                            <div class="dd3-content">{{$section['name']}}
                                                <div class="form-group float-right">
                                                    ...
                                                    <select class="" name="permission[{{$section['id']}}]">
                                                        ...
                                                        <option value="2">{{__('Read & Write')}}</option>
                                                        <option value="1">{{__('Read only')}}</option>
