...
<head>
   ...
   <title>Paradox - Forgot Password</title>
   <!-- =============== VENDOR STYLES ===============-->
   <!-- FONT AWESOME-->
         ...
         <div class="card card-flat ">
            ...
            @endif
               <p class="text-center py-2">Forgot Password</p>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="mb-3" id="loginForm"  novalidate >
                    @csrf
                  <div class="form-group">
                     <div class="input-group with-focus">
                        <input class="form-control border-right-0 borderLeft form-control @error('email') is-invalid @enderror" id="forgotInputEmail1" type="email" placeholder="Enter email" autocomplete="off" name="email" required>
                  ...
                  <div class="clearfix mt-4">
                     ...
                     <div class="float-right"><a class="theme_a txtunderline" href="{{route('dashboardListing')}}">Back to Login</a></div>
                  </div><button class="btn btn-block btn-themebutton mt-4" type="submit">Send</button>
               </form>
            </div>
         </div><!-- END card-->
