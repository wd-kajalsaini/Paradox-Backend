               ...
               <form class="mb-3" id="loginForm" method="POST" action="{{ route('login') }}" novalidate>
                  ...
                  <div class="form-group">
                     <div class="input-group with-focus">
                        <input class="form-control border-right-0 borderLeft @error('email') is-invalid @enderror" id="loginInputEmail1" type="email" placeholder="Enter email" name="email" autocomplete="off" value="{{ old('email') }}" required>
                  ...
                  <div class="form-group">
                     <div class="input-group with-focus"><input name="password" class="form-control border-right-0 borderLeft @error('password') is-invalid @enderror" id="loginInputPassword1"  type="password" placeholder="Password" required>
                  ...
                  <div class="clearfix mt-4">
                     <div class="checkbox c-checkbox float-left mt-0">
                        <label><input type="checkbox" value="" name="remember" {{ old("remember") ? 'checked' : "" }} >
                           <span class="fa fa-check"></span> Remember Me
                        </label>
                     </div>
                     <div class="float-right"><a class="theme_a txtunderline" href="{{route('password.request')}}">Forgot your password?</a></div>
                  </div><button class="btn btn-block btn-themebutton mt-4" type="submit">Login</button>
               </form>
            </div>
         </div><!-- END card-->
