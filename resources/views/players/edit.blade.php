        ...
        <div class="card m-3 border">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8 ">
                        <h4 class="mt-3">New Player Details</h4>
                    </div>
                ...
                <form method="post" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-8 col-md-10">
                                <textarea type="text" class="form-control" name="description" placeholder="" required>{{ $player->description }}</textarea>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <input type="text" class="form-control" name="instagram_profile_url" placeholder="" value="{{ $player->instagram_profile_url }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <input type="text" class="form-control" name="facebook_profile_url" placeholder="" value="{{ $player->facebook_profile_url }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <input type="text" class="form-control" name="ticktok_account" placeholder="" value="{{ $player->ticktok_account }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <input type="text" class="form-control" name="snapchat_account" placeholder="" value="{{ $player->snapchat_account }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <input type="text" class="form-control" name="twitch_account" placeholder="" value="{{ $player->twitch_account }}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8 col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <b>Preview</b>
                                        <div class="preview_thumb mt-2"><img id="blah" src="{{ !empty($player->thumbnail)?$player->thumbnail:asset('img/avatarEmpty.png') }}" alt="Player Thumbnail" />
