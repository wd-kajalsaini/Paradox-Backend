<div class="modal-header">
    <img class="mb-mail-avatar mr-2" alt="Mail Avatar" src="{{($inboxMessage->sender->avatar !=='' && @getimagesize(asset('images/users/'.$inboxMessage->sender->avatar))) ?asset('images/users/'.$inboxMessage->sender->avatar):asset('img/user.png')}}" style="width: 30px">
    <div>
