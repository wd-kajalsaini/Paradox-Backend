...
<section id="sectionManager"class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="p-3">
            <form method="POST" action="{{route('addKvitelProductAdd')}}" id="add_product">
                @csrf
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="row p-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="length" min="1" max="9" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <label class="switch switch-lg"><input type="checkbox" checked="checked" name="is_best" value="1"><span></span></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
