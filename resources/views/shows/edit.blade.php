                    ...
                    <div class="card bg-warning-dark border-0" style="padding:0px">
                        <div class="row align-items-center mx-0">
                            ...
                            <div class="col-8 py-4 bg-warning rounded-right">
                                ...
                                <a href="{{ route('subscribedShowUsers',$show->id) }}" style="color: white;">
                                    <p>View Subscribers <i class="fa fa-caret-right ml-1"></i></p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-primary-dark border-0" style="padding:0px">
                        <div class="row align-items-center mx-0">
                            ...
                            <div class="col-8 py-4 bg-primary rounded-right">
                                ...
                                <a href="{{ route('showQuestions',$show->id) }}" style="color: white;">
                                    <p>Add Questions <i class="fa fa-caret-right ml-1"></i></p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="post" data-parsley-validate="" id="edit_show" novalidate="" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-8 col-md-10">
                                    <input type="text" class="form-control 24hours-timepicker" name="start_time" placeholder="" value="{{ $show->start_time }}" style="background-color:white" required data-parsley-required-message="Please enter start time">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-8 col-md-10">
                                    <input type="text" class="form-control 24hours-timepicker" name="end_time" placeholder="" value="{{ $show->end_time }}" style="background-color:white" required data-parsley-required-message="Please enter end time">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-8 col-md-10">
                                    <div class="input-group date" id="datetimepicker1">
                                        <input class="form-control" type="text" name="date" readonly="readonly" value={{ $show->date }} style="background-color:white;" required data-parsley-required-message="Please select show date">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-8 col-md-10">
                                    <div class="input-group date" id="datetimepicker2">
                                        <input class="form-control" type="text" name="expiry_date" readonly="readonly" value={{ $show->expiry_date }} style="background-color:white;" required data-parsley-required-message="Please select expiry date" data-parsley-starttimecheck="true">
                                        <span class="fas fa-calendar-alt input-group-append input-group-addon"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-8 col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <b>Preview</b>
                                            <div class="preview_thumb mt-2"><img id="blah" src="{{ (!empty($show->banner))?$show->banner:asset('img/avatarEmpty.png') }}" alt="your image" />
...
<script>
    ...
    messages: {
        en: 'Expiry date and time must be equal to or greater than start date and time.'
    }
});
