    ...
    <div class="content-wrapper">
        ...
        <div class="card m-3 border">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-10 ">
                        <h4 class="mt-3">Edit Question</h4>
                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" placeholder="" value="{{ $show_question->title }}" required>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input class="form-control" type="number" name="duration" value="{{ $show_question->duration }}" required="" min="1">
