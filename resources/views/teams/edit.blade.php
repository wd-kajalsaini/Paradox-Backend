                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-9">
                                <select multiple id="showselection" name="players[]" placeholder="" class="form-control ctSelectBox1" required="" >
                                  ...
                                  <option  value="{{ $player->id }}" data-image="{{ !empty($player->thumbnail)?$player->thumbnail:asset('img/avatarEmpty.png') }}" <?php if(in_array($player->id, $selectedPlayers)){echo "selected"; } ?>>
                                    {{ $player->name }}
                                    </option>
                                    @endforeach
                                 </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <b>Preview:</b>
                                        <div class="preview_thumb mt-2"><img id="blah" src="{{ !empty($team['logo']) ? $team['logo']: asset('img/avatarEmpty.png') }}" alt="Team Logo" />
