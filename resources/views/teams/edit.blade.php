    ...
    <div class="content-wrapper">
        ...
        <div class="card m-3 border">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-10 ">
                        <h4 class="mt-3">Edit Team Details</h4>
                ...
                <form method="post" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" placeholder="" value="{{ $team['title'] }}" required>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-sm-9">
                                <select multiple id="showselection" name="players[]" placeholder="" class="form-control ctSelectBox1" required="" >
                                  ...
                                  <option  value="{{ $player->id }}" data-image="{{ !empty($player->thumbnail)?$player->thumbnail:asset('public/img/avatarEmpty.png') }}" <?php if(in_array($player->id, $selectedPlayers)){echo "selected"; } ?>>
                                    {{ $player->name }}
                                    </option>
                                    @endforeach
                                 </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <b>Preview:</b>
                                        <div class="preview_thumb mt-2"><img id="blah" src="{{ !empty($team['logo']) ? $team['logo']: asset('public/img/avatarEmpty.png') }}" alt="Team Logo" />
